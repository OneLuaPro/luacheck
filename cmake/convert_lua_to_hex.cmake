...
# Essentially reads luacheck.lua (the main script) and converts it into a C-header
# file for inclusion in luacheck.cpp. The contents of the generated header are pure
# hex values.
...
"#pragma once\n\n"
"static const unsigned char luacheck_source_bytes[] = {\n${FORMATTED_HEX}\n0x00\n};\n\n"
"static const unsigned int luacheck_source_size = sizeof(luacheck_source_bytes) - 1;\n"
)
